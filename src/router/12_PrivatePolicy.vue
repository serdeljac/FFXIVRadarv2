    ...
    <div :class="[`policy body_content`, windowWidth]">
        ...
        <div class="group">
            ...
            <ul>
                ...
                <li>No denial of goods or services will occur due to rights exercise.</li>
                <li>No provision of a different quality of goods or services.</li>
                <li>No imposition of penalties or unfavorable terms.</li>
            </ul>
...
<script lang="ts" setup>
    ...
    const pageTagLine = 'Effective Date: May 10, 2026 | Last Updated: July 5, 2026'
</script>
